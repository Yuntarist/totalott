  ...
  for (var v of urlKeys) {
    ...
    for (let i = 1; i < 11; i++) {
      ...
      gamersgate_discount_price.push(
        `<div class="gamersgate_discount_price">` +
          discount_price.substr(0, 7).replace(',', '') +
          `</div>`
      )
    }
  ...
  for (var v of urlKeys) {
    ...
    for (let i = 1; i < 11; i++) {
      ...
      greenmangaming_price.push(
        `<div class="greenmangaming_price">` + price.substr(0, 7) + `</div>`
      )
...
;(async () => {
  ...
  for (var v of urlKeys) {
    ...
    for (let i = 6; i < 16; i++) {
      ...
      dream_price.push(
        `<div class="dream_price">` +
          price.replace('&n', '').substr(0, 8) +
          `</div>`
      )
      ...
      dream_discount_price.push(
        `<div class="dream_discount_price">` +
          discount_price.substr(0, 8).replace('&n', '').replace('&', '') +
          `</div>`
      )
    }

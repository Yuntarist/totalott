...
;(async () => {
  ...
  for (var v of urlKeys) {
    ...
    for (let j = 0; j < gamersgate_aTag.length; j++) {
      ...
      console.log(v + '(aTag)', gamersgate_aTag)
      console.log(v + '(new_title)', gamersgate_new_title)
    }
  }
  await browser.close()
})()
...
;(async () => {
  ...
  for (var v of urlKeys) {
    ...
    for (let j = 0; j < greenmangaming_aTag.length; j++) {
      ...
      console.log(greenmangaming_new_title)
    }
    await browser.close()
  }
})()

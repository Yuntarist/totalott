...
;(async () => {
  ...
  console.log(urlv1) //원하는 객체값
    ...
    let game1 = `<div>${'steam : '+ steam_title[i] +'할인률: '+steam_discount_percent[i] +'원가 : ' + steam_price[i]+ '할인가 : ' +steam_discount_price[i]}</div>`
    steam.push(game1)
...
const gamersgate_discount_price = [];
    ...
    for(let j= 0; j<10; j++){
      const game2 = `<div>${'gamersgate : '+ gamersgate_title[j] +'할인률: '+gamersgate_discount_percent[j] +'원가 : ' + gamersgate_price[j]+ '할인가 : ' +gamersgate_discount_price[j]}</div>`
    ...
    for(let j= 0; j<10; j++){
      let game3 = `<div>${'greenmangaming : '+ greenmangaming_title[j] +'할인률: '+ greenmangaming_discount_percent[j] +'원가 : ' + greenmangaming_price[j]+ '할인가 : ' + greenmangaming_discount_price[j]}</div>`
    ...
    for(let j= 0; j<10; j++){
      let game4 = `<div>${'dreamgame : '+ dream_title[j] +'할인률: '+ dream_discount_percent[j] +'원가 : ' + dream_price[j]+ '할인가 : ' + dream_discount_price[j]}</div> `
  ...
  for(let j= 0; j<10; j++){
    let game5 = `<div>${'xbox : '+ dream_title[j] +'할인률: '+ dream_discount_percent[j] +'원가 : ' + dream_price[j]+ '할인가 : ' + dream_discount_price[j]}</div>  <br>`
    xbox.push(game5)
  }
